...
tabel = pd.read_csv('https://raw.githubusercontent.com/MaulanaYusufIkhsanRobbani/CapstoneProjectTetrisDQLABBatch4/data_umkm_ke4_openrevine_202402171115.csv')
...
with col1:
    ...
    sns.catplot(data=tabel, x=kolom_kategorik, y='RATA2_OMSET', kind="violin", inner=None)
